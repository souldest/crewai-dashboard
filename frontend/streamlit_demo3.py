...
st.markdown(
    "<p style='text-align:center; font-size:22px; line-height:1.5;'>Die Zukunft der Automatisierung beginnt heute.<br>Unser intelligentes System liefert KI-Agenten, die Ihren Geschäftsprozess revolutionieren.</p>",
    unsafe_allow_html=True
)

st.markdown(
    "<p style='text-align:center; font-size:24px; font-weight:700; color:#0073e6;'>▶ Jetzt Demo anfragen und das Potenzial entdecken</p>",
    unsafe_allow_html=True
)
